...
tags:
  - life
description: Where my cat's name came from and her background
---
...
<ImageCarousel
  images={[
    "/assets/origin-of-samp/Samp1.jpg",
    "/assets/origin-of-samp/Samp2.jpg",
    "/assets/origin-of-samp/Samp3.jpg",
    "/assets/origin-of-samp/Samp4.jpg",
  ]}
/>
## Table of contents
...
then connect to the game and let them live a virtual life. It was a really cool concept as a kid and it was super popular with my age group. When you got a new Webkinz stuffed animal, you had to register them with the game and do things like give them a name
and background. My first, and I think only, Webkinz I owned was a Bullfrog.

<figure>
  <img src="/assets/origin-of-samp/Bullfrog.webp" alt="Webkinz Bullfrog" />
...
did not really have an intention of adopting a cat at that time. However, we visited the kitten room and Samp (at the time her name was Brioche) kept jumping and climbing all over me and I instantly fell in love. I have never owned a cat in my life, so this was a
